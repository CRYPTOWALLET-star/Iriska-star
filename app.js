...
function showMainScreen() {
    ...
    document.getElementById('screenContent').innerHTML = `
        <div style="background: var(--card-bg); padding: 25px; border-radius: 20px; margin: 20px 0; text-align: center;">
            ...
            <div style="display: flex; justify-content: center; gap: 15px; font-size: 14px;">
                <span style="color: #00C6A2;">▲ 2.3% за день</span>
                <span style="color: var(--text-gray);">≈ ${(totalBalance / 85).toFixed(2)}₽</span>
            </div>
        </div>
        
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin: 25px 0;">
            <button class="button" onclick="showScreen('pay')">
                <i class="fas fa-paper-plane" style="font-size: 20px; margin-bottom: 8px;"></i><br>
                Оплатить
            </button>
            <button class="button button-primary" onclick="showScreen('receive')">
    ...
    document.getElementById('screenContent').innerHTML = `
        <div style="margin-bottom: 80px;">
            <div style="background: var(--card-bg); padding: 20px; border-radius: 15px; margin-bottom: 20px;">
                <p style="color: var(--text-gray); margin-bottom: 10px;">Выберите валюту</p>
                <select id="payCurrency" style="width: 100%; padding: 12px; border-radius: 10px; background: var(--dark-bg); color: white; border: 1px solid var(--text-gray);">
            ...
            <div style="background: var(--card-bg); padding: 20px; border-radius: 15px; margin-bottom: 20px;">
                <p style="color: var(--text-gray); margin-bottom: 10px;">Сумма</p>
                <input type="number" id="payAmount" placeholder="0.001" 
                    style="width: 100%; padding: 12px; border-radius: 10px; background: var(--dark-bg); color: white; border: 1px solid var(--text-gray); font-size: 18px;">
            ...
            <div style="background: var(--card-bg); padding: 20px; border-radius: 15px; margin-bottom: 20px;">
                <p style="color: var(--text-gray); margin-bottom: 10px;">Адрес получателя</p>
                <input type="text" id="payAddress" placeholder="bc1q..." 
                    style="width: 100%; padding: 12px; border-radius: 10px; background: var(--dark-bg); color: white; border: 1px solid var(--text-gray);">
            </div>
            ...
            <div style="margin-top: 30px; text-align: center;">
                ...
                <button class="button" onclick="showScreen('receive')" style="margin-top: 10px;">
...
function showReceiveScreen() {
    const selectedCrypto = allCryptos[0];
    ...
    document.getElementById('screenContent').innerHTML = `
        <div style="margin-bottom: 80px; text-align: center;">
            <div style="background: var(--card-bg); padding: 20px; border-radius: 15px; margin-bottom: 20px;">
                <p style="color: var(--text-gray); margin-bottom: 10px;">Выберите валюту</p>
                <select id="receiveCurrency" style="width: 100%; padding: 12px; border-radius: 10px; background: var(--dark-bg); color: white; border: 1px solid var(--text-gray);"
                    onchange="updateReceiveQR()">
                    ${allCryptos.map(crypto => 
            ...
            <div class="qr-container" style="margin: 30px auto;">
            ...
            <div style="background: var(--card-bg); padding: 20px; border-radius: 15px; margin: 20px 0;">
                ...
                <button class="button" onclick="copyAddress()" style="width: 100%;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 20px;">
                ...
                <button class="button button-primary" onclick="showScreen('main')">
...
function showHistoryScreen() {
    ...
    fakeHistory.forEach(tx => {
        ...
        historyHTML += `
            <div class="crypto-card" style="padding: 15px; margin: 10px 0;">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <div style="color: var(--text-gray); font-size: 12px;">${tx.date} • ${tx.address}</div>
                </div>
                <div style="text-align: right;">
    ...
    document.getElementById('screenContent').innerHTML = `
        <div style="margin-bottom: 80px;">
            ...
            ${historyHTML || '<p style="text-align: center; color: var(--text-gray); padding: 40px;">История транзакций пуста</p>'}
        </div>
    `;
}
...
function showSettingsScreen() {
    ...
    document.getElementById('screenContent').innerHTML = `
        <div style="margin-bottom: 80px;">
            <div style="background: var(--card-bg); padding: 20px; border-radius: 15px; margin-bottom: 20px; text-align: center;">
                ...
                <p style="color: var(--text-gray); font-size: 14px;">ID: #${userData ? userData.id.toString().slice(-4) : '0000'}</p>
            </div>
            
            <div class="settings-item">
                <div>
                    <div style="font-weight: 600;">Язык</div>
                    <div style="color: var(--text-gray); font-size: 14px;">Русский</div>
                </div>
            ...
            <div class="settings-item">
                <div>
                    ...
                    <div style="color: var(--text-gray); font-size: 14px;">Тёмная</div>
                </div>
                <i class="fas fa-chevron-right" style="color: var(--text-gray);"></i>
            </div>
            ...
            <div class="settings-item">
                <div>
                    ...
                    <div style="color: var(--text-gray); font-size: 14px;">PIN-код, Биометрия</div>
                </div>
                <i class="fas fa-chevron-right" style="color: var(--text-gray);"></i>
            </div>
            ...
            <div class="settings-item">
                <div>
                    ...
                    <div style="color: var(--text-gray); font-size: 14px;">Включены</div>
                </div>
                <i class="fas fa-chevron-right" style="color: var(--text-gray);"></i>
            </div>
            ...
            <div class="settings-item">
                <div>
                    ...
                    <div style="color: var(--text-gray); font-size: 14px;">Версия 1.0.0</div>
                </div>
                <i class="fas fa-chevron-right" style="color: var(--text-gray);"></i>
            </div>
